...
// */
//public class SimplePermissionsPlugin implements MethodCallHandler, PluginRegistry
...
//         requestPermissions(activity, perm, 0);
//    }
//
...
//        return PackageManager.PERMISSION_GRANTED ==  checkSelfPermission(activity, permission);
//    }
//
//    @Override
//    public boolean onRequestPermissionsResult(int requestCode, String[] permissions, int[]
//    grantResults) {
//        int status = 0;
//        String permission = permissions[0];
//        if (requestCode == 0 && grantResults.length > 0) {
//            if (shouldShowRequestPermissionRationale(registrar.activity(), permission)) {
//                //denied
//                status = 2;
//            } else {
//                if ( checkSelfPermission(registrar.context(), permission) == PackageManager
//                .PERMISSION_GRANTED) {
//                    //allowed
//                    status = 3;
//                } else {
